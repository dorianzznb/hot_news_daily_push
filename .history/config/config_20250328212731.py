...
# RSS配置
RSS_URLS = os.getenv('RSS_URLS', 'https://wewe.tuber.cc/feeds/all.atom?limit=20,https://openai.com/blog/rss.xml,https://www.jiqizhixin.com/rss,http://www.geekpark.net/rss,https://deepmind.google/blog/rss.xml').split(',')
